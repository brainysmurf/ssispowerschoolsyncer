...
from psmdlsyncer.utils import NS2, department_email_names, department_heads
...
def excluded_from_chinese_list(student):
    ...
    e.g. Singaporean family who doesn't want to be on the Chinese list
...
class PostfixTree(AutoSendTree):
